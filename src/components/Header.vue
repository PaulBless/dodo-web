            ...
            <nav class="relative z-50 flex justify-between">
                <div class="flex items-center md:gap-x-12">
                    ...
                    <a aria-label="Home" href="/">
                        <img src="../assets/biztel.png" width="90px" alt="" srcset="">
                    ...
                    <!-- page links -->
                    <!-- <div class="hidden w-full md:block md:w-auto menu-items"> -->
                    <div class="hidden md:flex md:gap-x-6 menu-items">
                        <ul class="list-reset flex lg:flex flex-row md:px-0"> <!--use flex class for router links-->
                            <li><router-link class="inline-block rounded-lg px-3 py-1 text-sm text-gray-600" :to="{name: 'products'}">Products</router-link></li>
                        ...
                        <div class="old hidden">
                            <a class="inline-block rounded-lg px-2 py-1 text-sm text-gray-600 hover:text-slate-900" href="/products">Products</a>
                            <a class="inline-block rounded-lg px-2 py-1 text-sm text-gray-600 hover:text-slate-900" href="/features">Features</a>
                            <a class="inline-block rounded-lg px-2 py-1 text-sm text-gray-600 hover:text-slate-900" href="/industries">Industries</a>
                            <a class="inline-block rounded-lg px-2 py-1 text-sm text-gray-600 hover:text-slate-900" href="/pricing">Pricing</a>
                            <a class="inline-block rounded-lg px-2 py-1 text-sm text-gray-600 hover:text-slate-900" href="/contact-us">Contact Us</a>
                        </div>
                ...
                <div class="flex items-center gap-x-5 md:gap-x-8">
                    <div class="hidden md:block">
                        <a class="inline-block rounded-lg px-2 py-1 text-sm text-slate-700 hover:underline hover:text-slate-900" href="/login">
                            Sign In
