            ...
            <nav class="relative z-50 flex justify-between">
                <div class="flex items-center md:gap-x-12">
                    ...
                    <a aria-label="Home" href="/">
                        <img src="../assets/dodo-logo.png" class="h-10 w-15" alt="Logo" srcset="">
                        <!-- <svg aria-hidden="true" viewBox="0 0 109 40" class="h-10 w-auto hidden">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M0 20c0 11.046 8.954 20 20 20s20-8.954 20-20S31.046 0 20 0 0 8.954 0 20Zm20 16c-7.264 0-13.321-5.163-14.704-12.02C4.97 22.358 6.343 21 8 21h24c1.657 0 3.031 1.357 2.704 2.98C33.32 30.838 27.264 36 20 36Z" fill="#2563EB"></path>
                    ...
                    <!-- page links -->
                    <div class="hidden md:flex md:gap-x-6 menu-items" >
                        <!--use flex class for router links-->
                        <div class="old links">
                            <router-link class="inline-block rounded-lg px-4 py-1 text-sm text-gray-600 hover:text-slate-900" to="/products">Products</router-link>
                            <router-link class="inline-block rounded-lg px-4 py-1 text-sm text-gray-600 hover:text-slate-900" to="/features">Features</router-link>
                            <router-link class="inline-block rounded-lg px-4 py-1 text-sm text-gray-600 hover:text-slate-900" to="/industries">Industries </router-link>
                            <router-link class="inline-block rounded-lg px-4 py-1 text-sm text-gray-600 hover:text-slate-900" to="/pricing">Pricing</router-link>
                            <!-- <router-link class="inline-block rounded-lg px-2 py-1 text-sm text-gray-600 hover:text-slate-900" to="/contact-us">Contact Us</router-link> -->
                        </div>
                ...
                <div class="flex items-center gap-x-5 md:gap-x-8">
                    <div class="hidden md:block">
                        <a class="inline-block rounded-lg px-2 py-1 text-sm text-slate-700 hover:underline hover:text-slate-900" href="https://app.usedodo.com">
                            Sign In
                    ...
                    <div class="-mr-1 md:hidden">
                        <button @click="toggleMobileMenu" class="relative z-10 flex h-8 w-8 items-center justify-center ui-not-focus-visible:outline-none" aria-label="Toggle Navigation" type="button" aria-expanded="false" >
...
.dodo-active-link{
    color: #304CE0;
    border-bottom: 2px solid #304CE0;
    border-radius: 0%;
    /* width: 90%; */
}
